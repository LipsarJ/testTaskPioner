...
import org.example.dao.dto.response.PageDTO;
...
public class UserController {
    ...
    @PutMapping("/update")
    public ResponseEntity<ResponseUserDTO> updateUser(@RequestBody @Valid RequestUserDTO requestUserDTO) {
        return ResponseEntity.ok().body(userService.updateUser(requestUserDTO));
    }
}
